 ...
 * 创建时间：2017/7/21
 */
public class GoodsConnectAdapter extends RecyclerView.Adapter{
    private List<GoodsContentBean.DatasBean.GoodsListBean> mList;
    private Context context;
    private boolean isChecked = false;
    private MyViewHolder mMyViewHolder;
    private OnItemClickListener mClickListener;

    public GoodsConnectAdapter(List<GoodsContentBean.DatasBean.GoodsListBean> list, Context context) {
        mList = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        mMyViewHolder.goodsPrice.setText("￥" + mList.get(position).getGoods_price());
        mMyViewHolder.goodsSalenum.setText("已售：" + mList.get(position).getGoods_salenum() + "件");
